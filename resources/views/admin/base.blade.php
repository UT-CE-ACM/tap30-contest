                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="list-group">
                            <a href="/admin/round" class="list-group-item @if(Request::segment(2) == 'round') active @endif">مراحل</a>
                            <a href="/admin/record" class="list-group-item @if(Request::segment(2) == 'record') active @endif">مسابقات</a>
